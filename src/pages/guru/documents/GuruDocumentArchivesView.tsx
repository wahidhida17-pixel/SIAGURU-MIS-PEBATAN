...
export const GuruDocumentArchivesView: React.FC = () => {
  ...
  // Filtered documents inside current folder
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh]">
        <LoadingSpinner />
        <p className="text-xs text-slate-500 mt-2">Memuat struktur arsip digital...</p>
      </div>
    );
  }
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div>
        <h1 className="text-xl sm:text-2xl font-extrabold text-slate-900 dark:text-slate-100">
          Arsip Dokumen Akademik & Administrasi
        </h1>
        <p className="text-xs text-slate-500">
          Penjelajah direktori arsip madrasah berbasis Tahun Ajaran dan Kategori Pembelajaran
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-xs flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-xs font-semibold">
          ...
          >
            <FolderOpen className="w-3.5 h-3.5 text-emerald-600" /> Root Arsip
          </button>
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            placeholder="Cari file dalam arsip..."
